...
class Initial extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->table('house_contibution')
            ...
            ->addColumn('social_service', 'boolean', [
                'default' => false,
                'limit' => null,
                'null' => false,
            ])
            ...
            ->addColumn('new_tenant_bar', 'boolean', [
                'default' => false,
                'limit' => null,
                'null' => false,
            ])
        ...
        $this->table('people_network')
            ...
            ->addColumn('data_access', 'boolean', [
                'default' => null,
                'limit' => null,
                'null' => false,
            ])
            ->addColumn('mail_access', 'boolean', [
                'default' => null,
                'limit' => null,
                'null' => false,
            ])
            ->addColumn('tim', 'string', [
                'default' => null,
                'limit' => 10,
                'null' => false,
            ])
        ...
        $this->table('people_network_memberships')
            ...
            ->addPrimaryKey(['id'])
            ->addColumn('networkinfo_id', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => false,
            ])
    ...
    public function down()
    {
        ...
        $this->dropTable('house_contibution');
        $this->dropTable('ips');
        $this->dropTable('jobs');
        $this->dropTable('macs');
        ...
        $this->dropTable('people_network');
        $this->dropTable('people_network_memberships');

...
/**
 * JosegonzalezCakeQueuesadillaPhinxlogFixture
 *
 */
class JosegonzalezCakeQueuesadillaPhinxlogFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'josegonzalez_cake_queuesadilla_phinxlog';

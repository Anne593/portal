...
?>
<li><?= $this->Html->link(__('Edit Working Group'), ['action' => 'edit', $workingGroup->id]) ?> </li>
<li><?= $this->Form->postLink(__('Delete Working Group'), ['action' => 'delete', $workingGroup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $workingGroup->id)]) ?> </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($workingGroup->name) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><?= $this->Text->autoParagraph(h($workingGroup->description)); ?></td>
        </tr>
    </table>
</div>

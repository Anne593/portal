        ...
        <div class="table-responsive">
            <table class="table table-striped" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link('', ['action' => 'view', $workingGroup->id], ['title' => __('View'),
                        'class' =>
                        'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['action' => 'edit', $workingGroup->id], ['title' => __('Edit'),
                        'class' =>
                        'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['action' => 'delete', $workingGroup->id], ['confirm' => __('Are
                        you sure
                        you want to delete # {0}?', $workingGroup->id), 'title' => __('Delete'), 'class' => 'btn
                        btn-default

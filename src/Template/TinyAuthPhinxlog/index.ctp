        ...
        <div class="table-responsive">
            <table class="table table-striped" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link('', ['action' => 'view', $tinyAuthPhinxlog->version], ['title' =>
                        __('View'), 'class' =>
                        'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['action' => 'edit', $tinyAuthPhinxlog->version], ['title' =>
                        __('Edit'), 'class' =>
                        'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['action' => 'delete', $tinyAuthPhinxlog->version], ['confirm' =>
                        __('Are you sure
                        you want to delete # {0}?', $tinyAuthPhinxlog->version), 'title' => __('Delete'), 'class' =>
                        'btn btn-default

...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            src/Template/Home/index.ctp with your own version.
        </div>
    ...
    <div class="row checks">
        <div class="col-lg-12">
            ...
            <p><i class="fa fa-check" aria-hidden="true"></i> Your version of PHP is 7.0.0 or higher
                (detected <?= PHP_VERSION ?>).</p>
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Your version of PHP is too low. You need PHP 7.0.0 or
                higher to use CakePHP (detected <?= PHP_VERSION ?>).</p>
            <?php endif; ?>

            <?php if (extension_loaded('mbstring')): ?>
            <p><i class="fa fa-check" aria-hidden="true"></i> Your version of PHP has the mbstring extension loaded.</p>
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Your version of PHP does NOT have the mbstring extension
                loaded.</p>;
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Your version of PHP does NOT have the openssl or mcrypt
                extension loaded.</p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Your version of PHP does NOT have the intl extension
                loaded.</p>
            <?php endif; ?>
            <hr>
            ...
            <p><i class="fa fa-check" aria-hidden="true"></i> The <em><?= $settings['className'] ?>Engine</em> is being
                used for core caching. To change the config edit config/app.php</p>
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Your cache is NOT working. Please check the settings in
                config/app.php</p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> CakePHP is NOT able to connect to the
                database.<br/><br/><?= $errorMsg ?></p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> DebugKit is NOT loaded. You need to either install
                pdo_sqlite, or define the "debug_kit" connection name.</p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Run the app migration with <code>$ bin/cake migrations
                migrate</code></p>
            <?php endif; ?>
            ...
            <p><i class="fa fa-check" aria-hidden="true"></i> Database is migrated.</p>
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Run the migration with <code>$ bin/cake migrations migrate
                -p Josegonzalez/CakeQueuesadilla</code></p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Seed the Database with <code>$ bin/cake migrations
                seed</code></p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Install Bower components with <code>$ bower install</code>
            </p>
            <?php endif; ?>
            ...
            <?php else: ?>
            <p><i class="fa fa-times" aria-hidden="true"></i> Change <code>MAIN_DOMAIN</code> to your setup inside the

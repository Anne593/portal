    ...
    <div class="box-body">
        <div class="table-responsive">
                ...
                <tr>
                                        ...
                                        <td class="actions">
                        <?= $this->Html->link('', ['action' => 'view', $modelHistory->id], ['title' => __('View'), 'class' =>
                        'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['action' => 'edit', $modelHistory->id], ['title' => __('Edit'), 'class' =>
                        'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['action' => 'delete', $modelHistory->id], ['confirm' => __('Are you sure
                        you want to delete # {0}?', $modelHistory->id), 'title' => __('Delete'), 'class' => 'btn btn-default

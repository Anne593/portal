...
<div class="emailtextUsers index large-9 medium-8 columns content">
    <h3><?= __('Emailtext Users') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $emailtextUser->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $emailtextUser->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $emailtextUser->id], ['confirm' => __('Are you sure you want to delete # {0}?', $emailtextUser->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

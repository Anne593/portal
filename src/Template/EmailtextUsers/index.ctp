        ...
        <div class="table-responsive">
                ...
                <tr>
                        ...
                        'Emailtexts', 'action' => 'view', $emailtextUser->emailtext->id]) : '' ?>
                                        ...
                                        <td class="actions">
                        <?= $this->Html->link('', ['action' => 'view', $emailtextUser->id], ['title' => __('View'), 'class' =>
                        'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['action' => 'edit', $emailtextUser->id], ['title' => __('Edit'), 'class' =>
                        'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['action' => 'delete', $emailtextUser->id], ['confirm' => __('Are you sure
                        you want to delete # {0}?', $emailtextUser->id), 'title' => __('Delete'), 'class' => 'btn btn-default

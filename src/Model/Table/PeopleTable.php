 ...
 * @property \Cake\ORM\Association\HasMany $HouseContibution
 * @property \Cake\ORM\Association\HasMany $Macs
 * @property \Cake\ORM\Association\HasMany $PeopleNetwork
...
class PeopleTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('HouseContibution', [
            'foreignKey' => 'person_id'
        ]);
        $this->hasMany('Macs', [
            'foreignKey' => 'person_id'
        ]);
        $this->hasMany('PeopleNetwork', [
            'foreignKey' => 'person_id'
        ]);
